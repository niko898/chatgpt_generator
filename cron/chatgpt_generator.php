...
log1("ChatGTP Generation Cron Job Started");
putenv("SERVER_NAME=localhost");

$loader->model('tool/chatgpt_generator');
$registry->get("model_tool_chatgpt_generator")->startGeneration();

log1("ChatGTP Generation Cron Job Finished");
